...
A demo showing how the Microsoft 365 Agents SDK can serve as an adapter to make an [A2A (Agent-to-Agent)](https://google.github.io/A2A/) protocol agent accessible through Microsoft Teams and Copilot 365.
